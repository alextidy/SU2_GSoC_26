...
A low M was chosen to limit transient / complex behaviour of the fluid response, allowing for easier convergence and thus validation of the custom boundary conditions.
