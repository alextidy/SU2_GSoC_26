...
// Meshing
// Axial
Transfinite Curve {1, 4, 9} = 40 Using Progression 0.87;         // Pre-nozzle
Transfinite Curve {2, 5, 10} = 140 Using Progression 1.04;      // After nozzle

// Radial
Transfinite Curve {3, 6, 7} = 16 Using Progression 0.9;        // Jet
Transfinite Curve {8, 11, 12} = 50 Using Progression 1.08;      // Jet expansion
